...
public class X_AM_AssetMeterLogDoc extends PO implements I_AM_AssetMeterLogDoc, I_Persistent 
{
    ...
    public X_AM_AssetMeterLogDoc (Properties ctx, int AM_AssetMeterLogDoc_ID, String trxName)
    {
      super (ctx, AM_AssetMeterLogDoc_ID, trxName);
      /** if (AM_AssetMeterLogDoc_ID == 0)
        {
			setAM_AssetMeterLogDoc_ID (0);
			setC_DocType_ID (0);
// 1000061
...
// N
    ...
    /** Load Constructor */
    public X_AM_AssetMeterLogDoc (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_AM_AssetMeterLogDoc[")
