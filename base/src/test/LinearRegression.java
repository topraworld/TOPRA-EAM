...
public class LinearRegression {
	...
	static Integer [] i = new Integer[]{1,2 ,3};
	
	private static final List<Integer> x = asList(i); // Consecutive hours developer codes
    private static final List<Integer> y = asList(4, 5, 7); // Number of bugs produced
